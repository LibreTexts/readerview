...
// function myFunction() {
//   var x = document.getElementById("citeSe").value; // Changed to .value to show selected option's value
//   document.getElementById("cite_holder").innerHTML = "Selected: " + x;
//   console.log(x);
// }
...
function getCite(verbose = false) {
  ...
  let citetemp = document.getElementById("citeSe").value;
